...
/*All page maps used by the system should be created by copying this one which only maps the kernel*/
...
[[nodiscard("The status code returned by this function must be checked")]]
enum vmm_status vmm_detach_frame(pagemap_table_t *const pml4, paddr_t *const frame_addr, vaddr_t page_addr);
